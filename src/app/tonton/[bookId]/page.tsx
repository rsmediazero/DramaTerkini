...
export async function generateMetadata({
  ...
  return {
    title: `Tonton ${meta.bookName ?? "Drama"} - ${config.PROJECT_NAME}`,
    description: meta.description ?? `Tonton ${meta.bookName ?? "Drama"}`,
    keywords: meta.tags,
    openGraph: {
      images: [
        {
